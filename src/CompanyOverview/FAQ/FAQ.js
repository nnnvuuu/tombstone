    ...
    rows: [
        {
            ...
            content:
            "答： 如果訂購固定圖案的常規墓碑，只需要墓園批準後半年的時間就 可以完成。家族碑需要墓園批準後八個月以上的時間完成。",
        },
        {
        ...
        },
        {
            ...
            content: `答：永龍歡迎家人來電詢價，但是必須注意幾個問題： 一， 由於各個墓園的規定不同，家人詢價時，要提供墓園的資料。 二， 除常規墓碑由於固定尺寸，價位相對穩定外，其他所有墓碑， 家人必須提供墓碑尺寸和墓園的地段資料才能報價。因為墓 碑的尺寸影響價格，而每個墓園對不同地段，都有規定。沒 有墓園的有關資料，用想當然的尺寸詢價，可能白忙一場。 三， 永龍報價包括一條龍服務，從代辦墓園申請文件，到圖案設 計、製造、送貨和安裝；此報價不包括墓園的地基費和申請 費。`,
        },
        {
...
rows: [
    {
        ...
        content:
        "A: If you order a regular tombstone with a fixed pattern, it only takes half a year after the cemetery’s approval to complete it. Family monuments take more than eight months to complete after cemetery approval.",
    },
    {
        title: <h4>2 Q: What are the dimensions that belong to the regular monument? </h4>,
        content:
            "A: The size of a conventional tombstone is for cemeteries in the eastern United States. There are two types of conventional monuments: single monument and double monument: single monument: main monument 20 x 8 x 30 base 24 x 12 x 8 double monument: main monument 36 x 8 x 24 base 42 x 12 x 8",
    },
    {
        title: <h4>3 Question: Yonglong Where are the tombstones produced?</h4>,
        content: `A: Yonglong’s tombstone factory is located in China. Large-scale monuments, special-shaped monuments, exquisite pattern carvings, as well as auspicious cups and sacrificial bottles are all produced in China. Due to the development of information technology and modern industries, there is only a distance in transportation, but no distance in management.`,
    },
    {
    ...
    },
    {
        ...
        content: `Answer: Yonglong tombstone has three major advantages: First, cultural advantages. In the process of making, Chinese square characters have their expressive artistic conception, which can only be mastered by Chinese masters. Second, communication advantages. Yonglong is a Chinese manufacturer, not a middleman. If your family has any requirements, you can communicate with us directly. Third, store advantage. Yonglongmen City Department has a large-scale stone tablet exhibition hall with complete information, which is convenient for family members to order.`,
    },
    {
